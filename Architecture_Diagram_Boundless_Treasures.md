...
graph LR
    %% 定义样式
    classDef input fill:#f9f,stroke:#333,stroke-width:2px,color:black,font-weight:bold;
    classDef core fill:#bbf,stroke:#333,stroke-width:2px,color:black,font-weight:bold;
    classDef app fill:#dfd,stroke:#333,stroke-width:2px,color:black,font-weight:bold;
    classDef physical fill:#fdd,stroke:#333,stroke-width:2px,color:black,font-weight:bold;
    classDef user fill:#fff,stroke:#333,stroke-width:4px,stroke-dasharray: 5 5,color:black,font-weight:bold;
    ...
    %% Subgraph Styling: Transparent Borders (No visible stroke)
    style Input_Layer fill:none,stroke-width:0px,color:black
    style Core_Layer fill:none,stroke-width:0px,color:black
    style Application_Layer fill:none,stroke-width:0px,color:black
    style Physical_Layer fill:none,stroke-width:0px,color:black
    
    %% Nested Subgraph Styling
    style Voyager_Zone fill:none,stroke-width:0px,color:black
    style Curator_Zone fill:none,stroke-width:0px,color:black
